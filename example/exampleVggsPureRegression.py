...
if __name__ == '__main__': 
  ...
  # load network
  deploy_file = '../models/regression/pure_regression_so_L1Loss_vggs/deploy.net'
  #model_file = '../models/regression/regularize_so_l2_vggs/regularize_so_l2.caffemodel'
  model_file = '../models/regression/pure_regression_so_L1Loss_vggs/snapshots/solver_iter_14000.caffemodel'
  caffe.set_mode_cpu()
  ...
  result = net.forward(data=caffe_input, blobs=['slope_regress', 'offset_regress'])

...
if __name__ == '__main__': 
  ...
  # load network
  deploy_file = '../models/regression/regularize_so_l2_vggs/deploy.net'
  #model_file = '../models/regression/regularize_so_l2_vggs/regularize_so_l2.caffemodel'
  model_file = '../models/regression/regularize_so_l2_vggs/snapshots2/solver_iter_29000.caffemodel'
  caffe.set_mode_cpu()

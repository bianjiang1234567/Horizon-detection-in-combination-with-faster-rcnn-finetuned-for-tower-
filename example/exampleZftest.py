...
if __name__ == '__main__': 
  ...
  # load network
  deploy_file = '../models/classification/so_placeszf/deploy.net'
  #model_file = '../models/classification/so_placeszf/ZF.v2.caffemodel'
  model_file = '../models/classification/so_placeszf/snapshots/_iter_70000.caffemodel'
  caffe.set_mode_cpu()

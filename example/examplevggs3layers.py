...
if __name__ == '__main__': 
  ...
  # load network
  deploy_file = '../models/classification/so_placesvggs_tower/deploy3.net'
  ...
  model_file = '../models/classification/so_placesvggs_tower/snapshots3/solver3_iter_90000.caffemodel'
  caffe.set_mode_cpu()
